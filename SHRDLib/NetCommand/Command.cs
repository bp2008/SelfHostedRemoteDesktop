...
namespace SHRDLib.NetCommand
{
	...
	public enum Command : byte
	{
		...
		GetScreenCapture = 10,
		/// <summary>
		/// The Master Server uses this to request that a Host Service authenticate itself by signing a random array of bytes.
		/// </summary>
		ClientAuthentication = 200,
		/// <summary>
		/// The Master Server can query the Host Service for this via the HostConnect protocol. In addition, the Host Service can choose to send HostStatus updates at any time, for example as an alternative to a KeepAlive packet.
		/// </summary>
		HostStatus = 201,
		/// <summary>
		/// This command, sent by the Master Server, instructs a Host Service to open an outgoing Web Socket connection which the Master Server will proxy to a Web Client.
		/// </summary>
		WebSocketConnectionRequest = 220,
		/// <summary>
